    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <p className="text-[10px] text-zinc-600">
          Por seguranca, o PIX cai sempre na chave-CPF do titular da conta (mesmo CPF do deposito).
          Cadastre seu CPF nos dados bancarios para liberar o saque. O valor e reservado na hora e pago apos a aprovacao do admin.
        </p>
      </form>
      {saques.length > 0 && (
