  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <input type="text" inputMode="decimal" placeholder="Valor (mín. R$ 5,00)" value={valor}
        ...
        <p className="text-[10px] text-zinc-600">O valor é reservado na solicitação e pago manualmente pelo administrador. Se rejeitado, volta pro seu saldo.</p>
      </form>
      {saques.length > 0 && (
