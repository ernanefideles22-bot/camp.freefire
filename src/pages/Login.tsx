  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center">
      <div className="bg-gray-900 p-8 rounded-xl shadow-2xl w-full max-w-md">
        <h1 className="text-3xl font-bold text-center text-white mb-8">ð¥ CAMP FREE FIRE</h1>
        ...
        <p className="text-center text-gray-500 mt-6">
          NÃ£o tem conta? <a href="/cadastro" className="text-orange-500 hover:underline">Cadastre-se</a>
        </p>
      </div>
    </div>
  );
